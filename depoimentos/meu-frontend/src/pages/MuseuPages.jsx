...
function MuseuPage() {
  ...
  return (
    <>
        ...
        <div className="bg-gray-700 p-8 text-center rounded-2xl max-w-4xl mx-auto">
          <h1 className="font-slab text-4xl text-white m-0">Museu das Palavras</h1>
          <p className="font-slab text-2xl text-gray-300 m-0 mt-2">Frases que atravessam os séculos para tocar o coração</p>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
             ...
             <div className="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
              <img className="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="img/testemunho35." alt="Imagem de fé" onClick={() => abrirImagem('/img/testemunho35.jpg')} />
              <div className="p-4 text-center">
      ...
      <section className="bg-white py-12 px-6">
        ...
        <div className="flex flex-col items-center w-full max-w-2xl mx-auto mt-10 p-4 rounded-lg shadow bg-blue-50">
          ...
          <input id="maryInput" className="p-2 w-full mb-2 rounded border" type="text" placeholder="Ex: nossa senhora das graças" />
          <button id="getMaryBtn" className="p-2 bg-blue-600 text-white text-xl font-slab rounded-lg w-auto mt-3 px-6">Buscar a Mensagem</button>
          <div id="maryMessage" className="mt-4 text-center"></div>
        </div>
      </section>
