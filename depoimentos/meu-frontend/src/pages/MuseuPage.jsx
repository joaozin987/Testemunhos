    ...
    <>
        ...
        <div className="mt-8 max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
            <img src="/src/assets/img/testemunho27.jpeg" alt="Imagem de Eucaristia" className="w-full h-40 object-cover cursor-pointer" onClick={() => abrirImagem('/img/testemunho27.jpeg')} />
          ...
          {/* Card 2 */}
          <div className="bg-white rounded-lg shadow-lg  overflow-hidden flex flex-col">
            <img src="/src/assets/img/testemunho30.jpeg" alt="Imagem de oração" className="w-full h-40 object-cover cursor-pointer" onClick={() => abrirImagem('/img/testemunho30.jpeg')} />
            <div className="p-4 flex flex-col flex-grow">
          ...
          {/* Card 3 */}
          <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
            <img src="/src/assets/img/testemunho33.jpeg" alt="Imagem de fé" className="w-full h-40 object-cover cursor-pointer" onClick={() => abrirImagem('/img/testemunho33.jpeg')} />
            <div className="p-4 flex flex-col flex-grow">
          ...
          {/* Card 4 */}
          <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
            <img src="/src/assets/img/testemunho28.jpeg" alt="Imagem de luz e oração" className="w-full h-40 object-cover cursor-pointer" onClick={() => abrirImagem('/img/testemunho28.jpeg')} />
            <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
              <img className="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="/src/assets/img/testemunho36.jpeg" alt="Celebração da Eucaristia" onClick={() => abrirImagem('/img/testemunho36.jpeg')} />
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
              <img className="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="/src/assets/img/testemunho37.jpeg" alt="Sacerdote em Oração" onClick={() => abrirImagem('/img/testemunho37.jpeg')} />
              <div className="p-4 text-center">
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
              <img className="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="/src/assets/img/DSC03260.jpg" alt="Adoração ao Santíssimo" onClick={() => abrirImagem('/img/DSC03260.jpg')} />
              <div className="p-4 text-center">
             ...
             <div className="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
              <img className="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="/src/assets/img/testemunho35.jpeg" alt="Imagem de fé" onClick={() => abrirImagem('/img/testemunho35.jpg')} />
              <div className="p-4 text-center">
             ...
             <div class="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
              <img class="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="/src/assets/img/testemunho38.jpeg" alt="Imagem de fé" Onclick={() => abrirImagem('/img/testemunho38.jpeg')} />
              <div class="p-4 text-center">
               ...
               <div class="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
              <img class="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="/src/assets/img/testemunho42.jpeg" alt="Imagem de luz" Onclick={() => abrirImagem('/img/testemunho42.jpeg')} />
              <div class="p-4 text-center">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
                <img class="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="/src/assets/img/testemunho40.jpeg" alt="Imagem de fé"  Onclick={() => abrirImagem('/img/testemunho40.jpeg')} />
                <div class="p-4 text-center">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
                <img class="w-full h-64 object-cover rounded-t-xl cursor-pointer" src="/src/assets/img/DSC03322.jpg" alt="Imagem de fé"  Onclick={() => abrirImagem('/img/DSC03322.jpg')} />
                <div class="p-4 text-center">
